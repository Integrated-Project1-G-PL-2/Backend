        ...
        httpSecurity.csrf(csrf -> csrf.disable())
                .authorizeRequests(
                        authorize -> authorize.requestMatchers("/login", "/error").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET, "/v3/boards/**").hasAnyAuthority("PUBLIC_ACCESS", "OWNER", "COLLABORATOR")
                                .requestMatchers(HttpMethod.GET, "/v3/boards").hasAnyAuthority("OWNER", "COLLABORATOR")
                                ...
                                .anyRequest().hasAnyAuthority("OWNER", "COLLABORATOR")
                )
